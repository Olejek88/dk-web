<td id="lcol">
	...
	<?php
	 ...
	 if ($_GET["obj"]=='1') print '<div class="photobox"><table><tbody><tr><td><a href="index.php?obj=1"><img src="files/1p7.jpg" align="center" style="border:2px solid #CCC;" width="250"></a></td></tr></tbody></table></div>';
 	 ...
 	 if ($_GET["obj"]=='51') print '<div class="photobox"><table><tbody><tr><td><a href="index.php?obj=50"><img src="files/nd.jpg" align="center" style="border:2px solid #CCC;" width="250"></a></td></tr></tbody></table></div>';
	 ...
	 if ($_GET["obj"]=='51') print '<font class="har">Код объекта <a href="index.php?obj=51">ufa[51]</a><br>';
	?>
