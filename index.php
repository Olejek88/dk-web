...
<?php
   if ($_GET["obj"]!='') 
   if ($_GET["sel"]=='' || $_GET["sel"]=='strukt' || $_GET["sel"]=='all' || $_GET["sel"]=='flat' || $_GET["sel"]=='rz2' || $_GET["sel"]=='rz3' || $_GET["sel"]=='rz4' || $_GET["sel"]=='signal' || $_GET["sel"]=='tech4' || $_GET["sel"]=='tech2') include ("info.php");
   if ($_GET["obj"]=='') include ("info2.php")
?>
