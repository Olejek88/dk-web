...
<table cellpadding="0" cellspacing="1" border="0" style="width:1100px" align=center>
<tr><td width=1100px bgcolor=#ffcf68 align=center><font class=tablz3>Показания коммерческого узла учета на входе в дом (дневные значения)</font></td></tr>
<tr><td style="width:1100px" valign=top>
<table cellpadding="0" cellspacing="1" border="0" style="width:1100px" align=center>
<tr>
<td style="width:400px" valign=top>
	...
	<td bgcolor=#ffcf68 align=center><font class=tablz>Qуд,ГКал/т.</font></td></tr>
	<?php  
		...
		for ($tn=0; $tn<80; $tn++)
			{
			 ...
			 while ($uy)
			      {
      			       	 if ($uy[8]==4 && $uy[6]==3) $data0[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==4 && $uy[6]==4) $data1[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==11 && $uy[6]==3) $data2[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==11 && $uy[6]==4) $data3[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==13 && $uy[6]==4) $data6[$x]=number_format($uy[3],3);

			       	 if ($uy[8]==4 && $uy[6]==0) $data10[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==4 && $uy[6]==1) $data11[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==11 && $uy[6]==0) $data12[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==11 && $uy[6]==1) $data13[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==13 && $uy[6]==0) $data16[$x]=number_format($uy[3],3);

			       	 if ($uy[8]==4 && $uy[6]==7) $data20[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==4 && $uy[6]==8) $data21[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==11 && $uy[6]==7) $data22[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==11 && $uy[6]==8) $data23[$x]=number_format($uy[3],2);
			       	 if ($uy[8]==13 && $uy[6]==7) $data26[$x]=number_format($uy[3],3);
...
for ($rr=0;$rr<$cnt;$rr++)	{ $date2[$rr]=substr($dat[$rr],0,5);  $data2[$rr]=$data6[$rr]; }
include ("highcharts/bar.php");
$cnt=80; $id=2; $name='Температура подающей (C)';
for ($rr=0;$rr<$cnt;$rr++)	{ $date2[$rr]=substr($dat[$rr],0,5);  $data2[$rr]=$data0[$rr]; }
include ("highcharts/bar.php");
$cnt=80; $id=3; $name='Температура обратной (C)';
for ($rr=0;$rr<$cnt;$rr++)	{ $date2[$rr]=substr($dat[$rr],0,5);  $data2[$rr]=$data1[$rr]; }
include ("highcharts/bar.php");
?>
</td></tr>
</table>
