		 ...
		 if ($dev[$rr]==$uy[1])
			{
			 ...
			 echo '['.$dev[$rr].'] Q['.$sect[$rr].']['.$str[$rr].'] se='.$sect[$rr].'='.$Q[$sect[$rr]][$str[$rr]].'<br>';
			 $sumq+=$uy[5];
			 $qq++;
			 break;
			}
		 ...
		 while ($uy = mysql_fetch_row ($a)) 
			{
			 ...
			 //if (($h2-$h1)<=0 || ($h2-$h1)>($h2/10)) echo '---['.$date1[$tn].'] ['.$sec.'/'.$strut.'/'.$level.'] ('.$uy[4].'='.$h2.')('.$uy[5].'='.$h1.') dh='.$dh[$sec][$strut][$level].' ['.$sdh[$sec][$strut].']<br>';
		 ...
		 while ($uy = mysql_fetch_row ($a)) 
			{
			 ...
			 echo '['.$date1[$tn].'] ('.$flat.'/'.$strut.'/'.$level.') '.$Q[$sec][$strut].'*'.$dh[$sec][$strut][$level].'/'.$sdh[$sec][$strut].'='.($Q[$sec][$strut]*$dh[$sec][$strut][$level]/$sdh[$sec][$strut]).' ['.$Qfl[$flat].']<br>';
