...
for ($tm=$mx; $tm>=$mn; $tm--)
     ...
     else
	{
     ...
     while ($uy)
         {          
	  //echo  $dat.' '.$uy[2].' '.$uy[3].' '.$uy[8].' '.$uy[6].'<br>';
	  if ($uy[8]==4 && $uy[6]==0) $data0[$x]=$uy[3];
	  //if ($uy[8]==4 && $uy[6]==1) $data1[$x]=$uy[3];
	  if ($uy[8]==12 && $uy[6]==5) $data2[$x]=$uy[3];
	  if ($uy[8]==12 && $uy[6]==6) $data3[$x]=$uy[3];	  
...
$graph = new Graph(400,190,"auto");	
$graph->img->SetMargin(30,30,5,30);
...
$graph->xaxis->SetTextTickInterval(4,0);
