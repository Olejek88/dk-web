...
//     echo $date1[$x].' '.$date2[$x].'<br>';
     if (($p==2 && $tm==1) || ($p==1 && $tm==1 && $ts==0))
	{
     ...
     if ($p==1) if ($x>400) break;
     if ($p==2) if ($x>60) break;
     $x++;
    }
$max=$x-1;
     ...
     if ($_GET["type"]=='1')
	{
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=4 AND value<110 AND source=0 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     ...
	     while ($uy)
		{
	     ...
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=4 AND value<110 AND source=1 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
     ...
     if ($_GET["type"]=='2')
	{
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=11 AND value<50 AND source=0 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
		{
	     ...
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=11 AND value<50 AND source=1 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
     ...
     if ($_GET["type"]=='3')
	{
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=12 AND value<1000 AND source=0 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
		{
	     ...
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=12 AND value<1000 AND source=1 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
     ...
     if ($_GET["type"]=='4')
	{
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=13 AND value<30 AND source=3 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
		{
	     ...
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=13 AND value<30 AND source=2 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
     ...
     if ($_GET["type"]=='5')
	{
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=12 AND source=5 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
		{
	     ...
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=12 AND source=6 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
     ...
     if ($_GET["type"]=='6')
	{
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=14 AND source=0 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
		{
	     ...
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=14 AND source=1 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
     ...
     if ($_GET["type"]=='7')
	{
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=4 AND source=10 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
		{
	     ...
	     $query = 'SELECT * FROM data WHERE type='.$p.' AND prm=13 AND value<10 AND source=2 AND flat=0 ORDER BY date DESC LIMIT 500';
	     //echo $query.'<br>';
	     $a = mysql_query ($query,$i);
	     if ($a) $uy = mysql_fetch_row ($a);
	     while ($uy)
...
else $graph = new Graph(400,215,"auto");
$graph->img->SetMargin(30,15,5,27);
...
$graph->legend->SetAbsPos(10,5,'right','top');
